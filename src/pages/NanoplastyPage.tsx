          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="flex items-center gap-4 justify-center md:justify-start border-y md:border-y-0 md:border-x border-stone-800 py-8 md:py-0 md:px-8">
                ...
                <div>
                  <h4 className="font-bold text-sm uppercase font-serif">Максимальний комфорт</h4>
          ...
          <div className="max-w-3xl mx-auto px-6 text-left">
            ...
            <div className="space-y-6">
              {[
                ...
                { q: "Чи можна робити нанопластику вагітним?", a: "Абсолютно. У складі немає формальдегіду, тому це найбезпечніша техніка випрямлення." },
