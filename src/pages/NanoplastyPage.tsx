...
import {
    Leaf, ShieldCheck, Clock, ArrowRight,
    CheckCircle, XCircle, Camera, Instagram
} from 'lucide-react';
            ...
            <Helmet>
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "offers": { "@type": "Offer", "priceCurrency": "UAH", "price": "1800" }
                    })}
                </script>
            </Helmet>
                ...
                <section className="relative min-h-[60vh] flex items-center border-b border-stone-900 overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-6xl mx-auto px-6 py-20">
                        <div className="max-w-3xl text-left">
                            <nav className="flex gap-2 text-stone-400 text-[10px] uppercase tracking-widest mb-8 font-bold">
                            ...
                            <p className="text-stone-200 text-lg md:text-xl mb-10 leading-relaxed max-w-2xl">
