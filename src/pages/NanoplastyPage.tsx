    ...
    return (
        <>
            ...
            <div className="pt-20 bg-stone-950 text-white selection:bg-[#D4AF37] selection:text-black font-sans">
                ...
                {/* 2. TRUST BAR у NanoplastyPage.tsx */}
                ...
                <section className="py-24 bg-stone-950">
                    <div className="max-w-4xl mx-auto px-6 text-center">
                        <h2 className="font-serif text-3xl md:text-5xl mb-16 tracking-tight uppercase">Кому підійде <br /> процедура нанопластики?</h2>
                        <div className="grid md:grid-cols-2 gap-8 text-left">
                            <div className="bg-stone-900/30 p-10 rounded-3xl border border-[#D4AF37]/30 shadow-lg">
                                ...
                                <ul className="space-y-6">
                                    {["Натуральне або нефарбоване волосся", "Жорсткий, етнічний або складний завиток", "Ви чутливі до запахів кератину", "Хочете максимально безпечний еко-склад"].map((item, i) => (
                            ...
                            <div className="flex flex-col justify-center p-10 bg-stone-900/10 rounded-3xl border border-stone-800 group">
                                <div className="mb-8 p-6 bg-red-900/5 rounded-2xl border border-red-900/20 text-stone-400 text-sm">
                                    ...
                                    Процедура нанопластики не підходить для сильно пошкодженого блонду. Кислотний склад може бути занадто активним для крихкої структури.
                                </div>
                    ...
                    <div className="max-w-4xl mx-auto px-6">
                        <div className="bg-gradient-to-br from-[#D4AF37] to-[#B8860B] p-10 rounded-[40px] text-stone-950 text-center relative overflow-hidden group shadow-2xl">
                            ...
                            <p className="mb-8 font-medium max-w-xl mx-auto">
                                Надішліть фото вашого волосся в Direct. Я безкоштовно проаналізую структуру та підберу ідеальний склад нанопластики.
                            </p>
                            <a
                ...
                {/* 6. FAQ у NanoplastyPage.tsx - Оновлений список */}
                <section className="py-24 bg-stone-950">
                    <div className="max-w-3xl mx-auto px-6 text-left">
                        <h2 className="font-serif text-3xl text-center mb-16 uppercase tracking-[0.2em] text-[#D4AF37]">FAQ</h2>
                        <div className="space-y-6">
                            {[
                                { q: "Чи змінить нанопластика мій колір?", a: "Так, колір може стати світлішим на 1-2 рівні через дію кислот. Це нормальна реакція, фарбування можливе через 14 днів." },
                                { q: "Чи випрямить нанопластика жорсткі кучері?", a: "Так, це одна з найсильніших процедур для натурального волосся. Вона справляється навіть з етнічним завитком." },
                                { q: "Як доглядати за волоссям?", a: "Тільки безсульфатний шампунь та сушка гарячим повітрям фена для активації блиску." },
                                { q: "Чим нанопластика відрізняється від кератину?", a: "Нанопластика працює на основі кислот і не містить формальдегіду. Вона безпечніша в процесі нанесення (немає запаху)." }
                            ].map((faq, i) => (
